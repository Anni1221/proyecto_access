...
const HeaderReportes = () => {
  ...
  return (
    <header className="App-header">
      ...
      <nav className="menu">
        <ul>
          <li><Link to="/TorreA"><i className="fas fa-building"></i> Torre A</Link></li>
          <li><Link to="/TorreB"><i className="fas fa-building"></i> Torre B</Link></li>
          <li><Link to="/TorreC"><i className="fas fa-building"></i> Torre C</Link></li>
          <li><Link to="/TorreD"><i className="fas fa-building"></i> Torre D</Link></li>
        </ul>
